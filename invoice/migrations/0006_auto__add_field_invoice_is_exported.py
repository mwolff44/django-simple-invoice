...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.is_exported'
        db.add_column(u'invoice_invoice', 'is_exported',
                      self.gf('django.db.models.fields.CharField')(default='no', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.is_exported'
        db.delete_column(u'invoice_invoice', 'is_exported')
