...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.is_credit_note'
        db.add_column(u'invoice_invoice', 'is_credit_note',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Invoice.invoice_related'
        db.add_column(u'invoice_invoice', 'invoice_related',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='credit_note', unique=True, null=True, to=orm['invoice.Invoice']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.is_credit_note'
        db.delete_column(u'invoice_invoice', 'is_credit_note')

        # Deleting field 'Invoice.invoice_related'
        db.delete_column(u'invoice_invoice', 'invoice_related_id')
