...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'invoice_invoice', 'number',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'invoice_invoice', 'number')
    ...
    models = {
        ...
        u'adherents.organization': {
            ...
            'begin_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime.now', 'null': 'True', 'blank': 'True'}),
            ...
            'billing_name': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
        ...
        u'contacts.contact': {
            ...
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'no_limit_event': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'invoice.invoicepayment': {
            ...
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'paid_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 1, 21, 0, 0)'})
        }
    }
