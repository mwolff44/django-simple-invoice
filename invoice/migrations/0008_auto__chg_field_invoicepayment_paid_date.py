...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InvoicePayment.paid_date'
        db.alter_column(u'invoice_invoicepayment', 'paid_date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'InvoicePayment.paid_date'
        db.alter_column(u'invoice_invoicepayment', 'paid_date', self.gf('django.db.models.fields.DateField')(null=True))
